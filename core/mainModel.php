<?php
    ...
    class mainModel {
        ...
        protected function decryption($string){
            $key=hash('sha256',SECRET_KEY);
            $iv=substr(hash('sha256',SECRET_IV),0,16);
            $output=openssl_decrypt(base64_decode($string),METHOD,$key,0
            ,$iv);
            return $output;
        }
        ...
        protected function limpiar_cadena($cadena){
            ...
            #(stripslashes) quita las barras de un string con comillas separadas
            $cadena=stripslashes($cadena);

            #(str_ireplace) remplazar los valores que lleguen en script
