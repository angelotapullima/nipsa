		...
		<div class="container-fluid">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form action="<?php echo SERVERURL; ?>ajax/administradorAjax.php" method="POST" data-form="" 
				    			...
				    			<div class="row">
				    				...
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	...
										  	<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="nombre-reg" 
				    				...
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="apellido-reg" 
											  required="" maxlength="30">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
