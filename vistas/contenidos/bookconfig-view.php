						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="titulo-up" required=""
									 maxlength="30">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="autor-up" required=""
									 maxlength="30">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-danger">
				...
				<div class="panel-body">
					<p class="lead">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi voluptatem quas impedit, sint eos corrupti
						cupiditate.
					</p>
					<form>
