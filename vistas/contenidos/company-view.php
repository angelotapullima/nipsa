						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" type="text" name="nombre-reg" required=""
									 maxlength="40">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,50}" class="form-control" type="text" name="director-reg" required=""
									 maxlength="50">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
