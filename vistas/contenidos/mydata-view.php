						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="nombre-up" required=""
									 maxlength="30">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="apellido-up" required=""
									 maxlength="30">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
