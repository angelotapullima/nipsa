		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					<img src="<?php echo SERVERURL ;?>vistas/assets/avatars/<?php echo $_SESSION['foto_nipsasession'] ; ?>" alt="UserIcon">
				...
				<ul class="full-box list-unstyled text-center">
					...
					<li>
						<a href="<?php echo $lc->encryption($_SESSION['token_nipsasession']) ; ?>" title="Salir del sistema" class="btn-exit-system">
